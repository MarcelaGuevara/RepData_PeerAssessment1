...
So, after this analysis, we can see that the mean of steps taken per day are `r mean` and the median of steps is `r median`.
...
|`r round(mean,4)`|`r median`|`r round(mean2,4)`|`r round(median2,4)`|  
